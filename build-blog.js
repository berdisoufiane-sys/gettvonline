 ...
 * page in the output directory, replacing the placeholder divs that used to
 * be filled in client-side via fetch(). This removes a render-blocking round
 * trip for visitors and, more importantly, makes navigation/footer links
 * (and their internal linking) visible to crawlers that don't execute JS.
 */
