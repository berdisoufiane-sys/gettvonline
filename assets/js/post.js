...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        postContainer.innerHTML = `
            <article class="prose prose-invert lg:prose-xl mx-auto">                ${post.imageUrl ? `<img src="${post.imageUrl}" alt="${post.title}" class="w-full rounded-lg mb-8" loading="lazy" decoding="async">` : ''}
